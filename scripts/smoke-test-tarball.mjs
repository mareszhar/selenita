...
`)
  ...
  // 8. Write tsconfig for CJS/NodeNext consumer
  ...
  // 9. Minimal CJS consumer — verifies the require() export path resolves correctly
...
`)
  ...
  // 12. Runtime CJS require check — actually load the CJS index entry
